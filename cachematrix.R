...
## Maxtrix inversion is usually costly when running inside of a loop
## When running time consuming computations, 
## it???s better to cache the results so that you can look them up later
## instead of computing them repeatedly.
